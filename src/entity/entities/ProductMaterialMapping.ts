...
@Entity("product_material_mapping", { schema: "jwellery" })
export class ProductMaterialMapping {
  ...
  @ManyToOne(() => Material, (material) => material.productMaterialMappings, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => Product, (product) => product.productMaterialMappings, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
